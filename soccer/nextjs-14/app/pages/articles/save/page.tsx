    ...
    <form onSubmit={handleSubmit(onSubmit)} className="max-w-sm mx-auto">
      ...
      <div className="editor mx-auto w-10/12 flex flex-col text-gray-800 border border-gray-300 p-4 shadow-lg max-w-2xl">
        ...
        <textarea
          ...
          className="description bg-gray-100 sec p-3 h-60 border border-gray-300 outline-none" placeholder="Describe here" name="content" onChange={handleInsertContent}></textarea>
        {/* <!-- icons --> */}
        ...
        <div className="buttons flex">
          <input type="submit" value="POST" className="btn  overflow-hidden relative w-30 bg-blue-500 text-white p-3 px-8 rounded-xl font-bold uppercase -- before:block before:absolute before:h-full before:w-1/2 before:rounded-full
